...
function UserCard({data, refetch}) {
  ...
  return (
    <Div $marginTop="2rem" width="100%" height="300px" $fDirection="row">
      <Div>
        <img src="src/assets/imgs/default.webp" alt="userProfileImg" style={{width:"300px", height: "300px"}}/>
      </Div>
      ...
      <Div width="100%" height="100%" $fDirection="row" bgColor="#e6e6e6" padding="0 0 1rem 0" style={{boxSizing:"border-box", borderBottom:"1px solid #767676"}}>
          ...
          {/* <Button onClick={()=>{
              ...
              ? 
                  ...
                  <Button bgColor="#767676" color="white" >취소</Button>
                  {/* onClick={()=>{mutate({"nickname" : changedNickname})}} 밑에 */}
                  <Button bgColor="#644AFF" color="white" >수정완료</Button>
                  </Div>
                //   onClick={changeNicknameHandler}밑에!
